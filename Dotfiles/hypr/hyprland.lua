...
hl.config({
  general = {
    ...
    border_size = 2,
    col = {
      active_border = "rgb(FFD700)",
      inactive_border = "rgb(ffff00)",
    },
...
-- Multimedia keys (locked so they work even when screen is locked, repeating for press-and-hold)
